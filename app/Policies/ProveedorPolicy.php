...
class ProveedorPolicy
{
    ...
    {
        if ($user->hasPermissionTo('Ver proveedor')) {
            return true;
        }
        return false;
    }
    ...
    {
        if ($user->hasPermissionTo('Crear proveedor')) {
            return true;
        }
        return false;
    }
    ...
    {
        if ($user->hasPermissionTo('Editar proveedor')) {
            return true;
        }
        return false;
    }
    ...
    {
        if ($user->hasPermissionTo('Eliminar proveedor')) {
            return true;
        }
        return false;
    }
